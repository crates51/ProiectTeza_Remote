		...
		<div class="row">
			<div class="col-md-4 mt-5 offset-2">
				<div class="form-group">
					...
					{{Form::text('accommodationName',$data['currentGeneralInfo']->name ,['class' =>'form-control tac','placeholder' => 'Nume Cladire' ])}}
				</div>	
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 mt-5 offset-2">
				<div class="form-group">
					...
					{{Form::text('totalRooms',$data['currentGeneralInfo']->totalRooms ,['class' =>'form-control tac','placeholder' => 'Nume Cladire' ])}}
				</div>	
			</div>
		</div>
		 <div class="row">
