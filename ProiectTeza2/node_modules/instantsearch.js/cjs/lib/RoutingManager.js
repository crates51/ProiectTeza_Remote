...
function () {
  ...
  _createClass(RoutingManager, [{
    ...
    value: function getConfiguration(currentConfiguration) {
      ...
      this.originalConfig = (0, _algoliasearchHelper.default)({}, currentConfiguration.index, currentConfiguration).state; // The content of getAllSearchParameters is destructured to return a plain object
    ...
    value: function setupRouting(state) {
      ...
      this.router.onUpdate(function (route) {
        ...
        if ((0, _isEqual.default)(uiState, currentUIState)) return;
        ...
        if ((0, _isEqual.default)(fullHelperState, searchParameters)) return;
