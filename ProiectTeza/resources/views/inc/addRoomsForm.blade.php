	<div class="modal fade" id="prepareRoomsModal" tabindex="-1" role="dialog" aria-labelledby="prepareRoomsModalLabel" aria-hidden="true">
      ...
      {!! Form::open(['action' => ['RoomsController@store',$data['currentTotalRooms']],'method' => 'POST','enctype'=>'multipart/form-data']) !!}
            {{-- {{$data['currentGeneralInfo']->totalRooms}} --}}
            @for ($i = $data['previousTotalRooms']+1; $i <= $data['currentTotalRooms']; $i++)
              ...
              <div class="row">
                <div class="col-md-12 ">
                  <div class="form-group tac">
                    {{Form::label('', 'Room '.$i,['class'=>"text-center"])}}
                  </div>
                </div>
              </div>
               <div class="row">
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                  <div class="form-group tac">
                    {{Form::number('numberOfBeds_'.$i,'1',['class' =>'form-control tac','placeholder' => 'Number of beds'])}}
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-4 offset-4">
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-4 offset-4 tac">
                          {{Form::label('floorId', 'Etaj',['class'=>"text-center"])}}
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-8 offset-2">
                          {{Form::number('floorId_'.$i,'1',['class' =>'form-control tac','placeholder' => 'Etajul','min' => 0])}}
                        </div>
                      </div>
                    </div>  
                </div>
